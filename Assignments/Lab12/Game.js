...
class Game
{
    ...
    initWorld()
    {
        ...
        this.joinButton.addEventListener("click", this.join.bind(null,this.ws));

        this.gameOverButton = document.getElementById("gameOver");
        this.gameOverButton.addEventListener("click", this.gameOver.bind(null,this.ws));

        document.addEventListener("click",this.hi.bind(null,this.ws))
